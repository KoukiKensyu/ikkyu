...
<div class="d-flex justify-content-center">
  <div class="card" style="width: 40rem;">
    <table border="1" class="table">
      ...
      <td>{{$reservations[0]->price * $reservations[0]->day->d * $reservations[0]->rooms}}円</td>
    </table>
      本当にキャンセルしますか
      ...
      <button type="button" onclick="location.href='/mypage/index'" class="btn btn-outline-info" data-mdb-ripple-color="dark" name="return">マイページへ</button>
    </div>
  </div>
</div>
@endsection